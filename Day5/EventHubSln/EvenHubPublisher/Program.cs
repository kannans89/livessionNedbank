...
class Program
{
    private const string connectionString = "Endpoint=sb://day5rg.servicebus.windows.net/;SharedAccessKeyName=SendPolicy;SharedAccessKey=Z6lS5hEEGCG2mn8UUFTWK/4cTPkhsvbLX+AEhMLwsR0=;EntityPath=apphub";
